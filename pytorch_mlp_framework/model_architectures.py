...
class ConvolutionalBatchNormalizationBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ConvolutionalBatchNormalizationBlock, self).__init__()
...
class ResidualConvolutionalBatchNormalizationBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ResidualConvolutionalBatchNormalizationBlock, self).__init__()
...
class ConvolutionalDimensionalityReductionBatchNormalizationBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(ConvolutionalDimensionalityReductionBatchNormalizationBlock, self).__init__()
